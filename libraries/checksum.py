...
class FileChecker:
    ...
    def append(self, data: list):
        '''Append the list of files to check'''
        with self.__lock:
    ...
    def check_for_files(self):
        ...
        regularity = CONFIG['libraries']['global']['autofilecheck'].value
            ...
            while self.__list:
                ...
                if Path(full_path).is_file():
                    ...
                    if checksum != item['checksum']:
                        print("FILE HAS GONE BAD {}".format(full_path))
