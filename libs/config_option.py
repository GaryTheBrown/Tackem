...
class ConfigOption(ConfigBase):
    ...
    def html_option(self, value=None) -> str:
    ...
    def html_radio(self, variable_name: str, value=None) -> str:
    ...
    def html_checkbox(self, variable_name: str, checked: bool = False) -> str:
        '''returns a checkbox'''
